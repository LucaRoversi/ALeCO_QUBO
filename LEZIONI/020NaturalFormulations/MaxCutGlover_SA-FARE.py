...
ham_penalita   = Constraint(c0 + c1 - 2*c0*c1, label="constr0")
ham_penalita  += Constraint(c0 + c2 - 2*c0*c2, label="constr1") 
ham_penalita  += Constraint(c1 + c2 - 2*c1*c2, label="constr2") 
ham_penalita  += Constraint(c1 + c3 - 2*c1*c3, label="constr3") 
ham_penalita  += Constraint(c2 + c4 - 2*c2*c4, label="constr4") 
ham_penalita  += Constraint(c3 + c4 - 2*c3*c4, label="constr5") 
ham_penalita  += Constraint(c3 + c5 - 2*c3*c5, label="constr6") 
