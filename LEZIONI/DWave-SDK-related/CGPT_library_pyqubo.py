...
# 2. funzione penalitàç penalizza le soluzioni in cui la somma delle variabili binarie non è uguale a 2. È definita, utilizzando la classe `Constraint` da `pyqubo`. 
